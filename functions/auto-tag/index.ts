...
export async function onRequestGet() {
  return json({
    ...
    note: "This HTTP route exists for production diagnostics. Tag generation is driven by Sanity document events.",
  });
}
...
export async function onRequestPost() {
  return json({
    ...
    kind: "status-endpoint",
    automationTrigger: "sanity blueprint document function",
    note: "This endpoint is reachable in production, but the real tag automation runs from Sanity document events.",
  });
}
